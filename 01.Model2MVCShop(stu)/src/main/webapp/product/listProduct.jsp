...
<%}else{%>
	<td align="left"><a href="/updateProductView.do?prodNo=<%=vo.getProdNo() %>&menu=<%=menu%>"><%=vo.getProdName() %></a></td>
<% 	}	%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		...
		%>
			...
			<a href="/listProduct.do?page=<%=i%>&menu=<%=menu%>&searchKeyword=<%=URLEncoder.encode("keyword","EUC-KR")%> &searchCondition=<%=condition%>"><%=i %></a>
